...
import filRouge.service.OrderService;
...
public class OrderRestController {
	...
	@GET
	@Path("/client/{id}")
	public Response getAllOrdersByClient(@PathParam("id") Integer id) {
		List<Order> orders = orderService.findAllCommandByClient(id);
		return Response.ok(orders).header("reponse", "ca marche").build();

...
public ClientFormBean load(Integer loadId){
   ...
   client.setId(loadId); 
   client.setCompanyName("Nom de la compagnie " + loadId);
   client.setFirstName("Prénom " + loadId);
   client.setLastName("Nom " + loadId);
   client.setEmail("Email " + loadId);
   client.setPhone("Numéro de téléphone " + loadId);
   client.setAdress("Adress " + loadId);

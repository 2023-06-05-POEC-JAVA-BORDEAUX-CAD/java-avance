...
public class PojoJpaDaoTest {
    ...
    public Properties config() throws Exception {
        ...
        p.put("jtaTestDataSource.JdbcUrl", "jdbc:h2:file:C:/dev/h2-data/formation-poe-java");
        return p;
    }
    
	@Test
	public void testSave() throws Exception {
		Assertions.assertNotNull(pojoJpaDao);
		
		PojoJpa pojoJpa = new PojoJpa();
		pojoJpa.setNom("coucou");
		this.pojoJpaDao.save(pojoJpa);
	}

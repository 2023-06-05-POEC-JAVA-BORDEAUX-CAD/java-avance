...
stopTomee:
	...
	rm D:\apache-tomee-webprofile-9.1.0\webapps\poe-java-av-jdbc-1.0.0-SNAPSHOT -r
	rm D:\apache-tomee-webprofile-9.1.0\webapps\poe-java-av-jdbc-1.0.0-SNAPSHOT.war